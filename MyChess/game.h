...
public:
	...
	static void game() {
		...
		{
			case WHITE_MOVE: gameStaticPtr->movementFigure(gameStaticPtr->m_currentTeamMove); break;
			case BLACK_MOVE: gameStaticPtr->movementFigure(gameStaticPtr->m_currentTeamMove); break;
		}
	...
	static void timer(int = 0) {
		...
		switch (gameStaticPtr->m_killingKing){
			case WHITE_KING: glColor3f(0.1, 0.1, 0.1); break;
			case BLACK_KING: glColor3f(0.9, 0.9, 0.9); break;
			case LIVE_BOTH: glutTimerFunc(100, timer, 0); return;
		}
...
private:
	...
	CurrentTeamMove m_currentTeamMove = CurrentTeamMove::WHITE_MOVE;
	KillingKing m_killingKing = KillingKing::LIVE_BOTH;
