...
namespace chess {
	...
	public:
		...
		void drawFigur() override {
			switch (m_teamColor)
			{
			case TeamColor::WHITE: glColor3f(1.0, 1.0, 1.0); break;
			case TeamColor::BLACK: glColor3f(0.0, 0.0, 0.0); break;
			}
		...
		bool checkMoveFigure(Cell* cell) override {
